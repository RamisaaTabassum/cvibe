const CVPreview = ({ data, template = "dark" }) => {
  const getHeaderBg = () => {
    ...
    return "bg-[#111118] text-white";
  };

  return (
    <div
      id="cv-preview-content"
      className="w-full max-w-[850px] mx-auto bg-white text-slate-900 rounded-lg shadow-2xl border border-gray-200 overflow-hidden transition-all duration-300 print:max-w-none print:rounded-none print:shadow-none print:border-0"
    >
      <div
        className={`p-6 sm:p-8 ${getHeaderBg()} text-left space-y-1 transition-colors duration-200`}
      >
      ...
      <div className="p-6 sm:p-8 min-h-[600px] bg-white text-left space-y-6 font-['DM_Sans',sans-serif] print:p-6">
        <div className="space-y-1">
          <h3 className="text-[12px] font-bold tracking-widest text-[#7c5cfc] uppercase">
            Summary
          </h3>
