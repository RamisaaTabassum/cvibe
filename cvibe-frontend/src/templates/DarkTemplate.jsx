const DarkTemplate = ({ data }) => {
  ...
  return (
    <div className="bg-gray-900 text-white w-full min-h-[297mm] p-8 font-sans print:bg-white print:text-black">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {skills.map((skill, i) => (
              <span
                key={i}
                className="px-3 py-1 text-sm text-purple-300 border border-purple-400 rounded"
              >
                {skill}
              </span>
            ))}
